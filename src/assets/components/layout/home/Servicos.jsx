...
function Servicos() {
  return (
    <div className="servicos">
      ...
      <p>
        ● Turn Key 360º: Solução cobrindo todo o ciclo do projeto solar, desde o
        design até a operação, garantindo praticidade e eficácia.
      </p>
      <p>
        ● BOS (Balance of System): Integração de todos os componentes do sistema
        fotovoltaico, além dos painéis solares, para uma implementação
        eficiente.
      </p>
      <p>
